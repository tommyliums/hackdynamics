...
// </copyright>
// <summary>
//   Defines the JsonTransformAction type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace Hynamick.SearchAnswer
{
    ...
    public class JsonTransformAction
    {
        ...
        /// <summary>
        /// Gets or sets whether reference type disable double quote surround. For reference type like sting, if set to true, no quote will added.
        /// </summary>
        ...
        {
            return $"Type: {this.Type}, TemplateName: {this.TemplateName}, Select: {this.Select}, NoQuote: {this.NoQuote}";
        }
    }
}
