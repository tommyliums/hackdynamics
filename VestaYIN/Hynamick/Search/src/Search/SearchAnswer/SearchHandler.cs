...
namespace Hynamick.Search.SearchAnswer
{
    ...
    public class SearchHandler : ISearchHandler
    {
        ...
        public virtual async Task<SearchResponse> Search(string source, string locale, string query, int count)
        {
            ...
            try
            {
                ...
                var sourceResponse = await this.GetSourceResponse(searchRequest);
