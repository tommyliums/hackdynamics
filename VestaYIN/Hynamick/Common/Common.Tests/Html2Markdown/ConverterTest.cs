...
namespace Html2Markdown.Tests
{
    ...
    public class ConverterTest
    {
        ...
        {
            _testPath = AppDomain.CurrentDomain.BaseDirectory + @"\TestFiles\";
        }
...
<p>Body tags should be removed</p>
        ...
        [TestMethod]
        [DeploymentItem(@"TestFiles\TestHtml.txt", "TestFiles")]
...
## Usage
        ...
        [TestMethod]
        [DeploymentItem(@"TestFiles\msoContent.txt", "TestFiles")]
        [DeploymentItem(@"TestFiles\msoContent_Expected.txt", "TestFiles")]
        public void Convert_Mso_Content()
        {
            var sourcePath = _testPath + @"msoContent.txt";
            var expected = File.ReadAllText(_testPath + @"msoContent_Expected.txt");
